...
public class AccountServiceImpl implements AccountService {
	...
	public void withdraw(int accountId, double amount) {
		...
		account.setBalance(account.getBalance()-amount);
		accountDao.updateAccount(account);
		//transactionLogService.addTransactionLog(accountId,"Withdraw amount", amount, TransactionType.WITHDRAW);
	}
	...
	public void tranfer(int fromAccountId, int toAccountId, double amount) {
		...
		//transactionLogService.addTransactionLog(fromAccountId,"Transfer amount",amount, TransactionType.TRANSFER);
	}
